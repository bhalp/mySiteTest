var gsCurrentVersion = "6.31 2021-03-10 03:38";  // 1/5/21 - v5.6 - added the ability to show the current version by pressing shift F12
...
//var gsCurrentVersion = "6.31 2021-03-07 19:00";  // 1/5/21 - v5.6 - added the ability to show the current version by pressing shift F12
...
//var gsTDAPIKey = "5V5GTTHEURLAUGI2JAFC06QKAIVPAVYF";
...
function WLWatchList() {
    ...
    this.watchlistId = ""; //if name is "Account" this is accountId + name, if name is "Account Saved Orders" this is accountId + "AccountSavedOrders"
    this.accountId = "";
    this.accountName = "";
    this.WLItems = new Array(); //array of WLItem objects or oCMSavedOrders objects
}
...
function GetTradesAddSymbol(iAccountsIdx, sSymbolsToLookup, sRADSymbol, oTradeIn) {
    ...
    if (bNeedToAddSymbol) {
        ...
        oSymbol.trades[oSymbol.trades.length] = oTrade;
        oSymbol.fees = oTrade.fees; //03/10/21 added .fees
        gSymbols[gSymbols.length] = oSymbol;
    }
