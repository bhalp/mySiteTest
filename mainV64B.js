var gsCurrentVersion = "6.4 2021-03-10 16:33";  // 1/5/21 - v5.6 - added the ability to show the current version by pressing shift F12
...
function WLWatchList() {
    ...
    this.bSelectedSOOrders = false;
    this.bSelectedSOTemp = false;
    this.bSelectedSOTempOrders = false;
    ...
    if (gbUsingCell) {
        ...
        for (let idx = 0; idx < gWatchlists.length; idx++) {
            if (gbDoingSymbolsSelect) {
                ...
                gWatchlists[idx].bSelectedSO = gWatchlists[idx].bSelectedTempSO;
