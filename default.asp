...
<%dim gsBearerCode
    dim gsRefresh_Token
    dim gsAccess_token_expiration_time

    gsBearerCode = request("code")
    gsRefresh_token = request("refreshToken")
    gsAccess_token_expiration_time = request("expirationTime")
...
<style type="text/css">
	A:link   { color: blue; cursor: inherit } 
	A:active { color: red; cursor: inherit }
...
<script type="text/javascript" src="SiteSpecific010321b.js"></script>
<script type="text/javascript" src="HIUtilities022121a.js"></script>
<script type="text/javascript" src="JSON.js"></script>

<script type="text/javascript" >
<!--
    var gsRefreshToken = "<%=gsRefresh_token%>";
    var gsAccessTokenExpirationTime = "<%=gsAccess_token_expiration_time%>";
    var gsBearerCode = "<%=gsBearerCode%>";

    var gbUsingCell = true;
    var gbShowSavedOrders = false;
    //var gsRedirectURL = "https://bhalp.github.io/mySite/default.htm";
    //var gsRedirectURL = "https://bhalp.github.io/mySiteTest/default.htm";
    var gsRedirectURL = "https://localhost:8080";
    //var gsTDAPIKey = "5V5GTTHEURLAUGI2JAFC06QKAIVPAVYF"; //MyGainLoss2
    var gsTDAPIKey = "VTBLS2XWYV8HCIHN8JSTSHEZTFZXNI93"; //MyGainLoss
    ...
    var gsMarketsToTrackDesc = new Array("Dow 30", "Nasdaq", "S&P 500");
    var gsMarketsToTrackTDName = new Array("tdDJI", "tdNasdaq", "tdSP");
    ...
    function TDWLOrder() {
        ...
        this.aWL07purchasedDate = "\"purchasedDate\": "; //like "2021-0201" followed by a comma
    ...
    function DoWLOpenSymbols(idxWL) {
        if (!gbDoingCreateOrders && !gbDoingGetTrades && !gbDoingGetTDData && !gbDoingStockPriceHistory) {
            ...
            let sAcquiredDate = document.getElementById("txtwlacquired" + sThisId).value;
                                    ...
                                    for (let idxItemDetail = 0; idxItemDetail < oWLDisplayed.WLItemDetails.length; idxItemDetail++) {
                                        ...
                                        if (bOkToShowThisDetail) {
                                            ...
                                            if (goWLDisplayed[sThisId + sSymbol].purchasedDate == sTmp) {
                                                ...
                                                if (sTmp == "") {
                                                    sThisTable = sThisTable + "<td style=\"text-align:left; vertical-align:" + sTableRowVerticalAlignment + "; border-width:0px; \">nbsp;</td>";
                                                } else {
                ...
                if (gWatchlists[idxWL].bSelectedSO) {
                    ...
                    if (iReturn == 0) {
                        ...
                        if (gbUsingCell) {
                            ...
                            sThisDiv = sThisDiv + "<th style=\"height:30px; vertical-align:middle; border-top-width:1px; border-bottom-width:1px; border-left-width:0px; border-right-width:0px; border-style:solid;border-spacing:0px;border-color:White\"><b>" + sLastWLAccountName + "--" + sLastWLName + "</b></th>";
                            ...
                            sThisDiv = sThisDiv + "<th style=\"width:" + giWLColTitleWidth.toString() + "px; vertical-align:middle; border-top-width:1px; border-bottom-width:1px; border-left-width:0px; border-right-width:0px; border-style:solid;border-spacing:0px;border-color:White\"><b>" + sLastWLAccountName + "--" + sLastWLName + "</b></th>";
    ...
    function PageLoad() {
        ...
        if (gbUsingCell) {
            ...
            let sTmp = ""
            sTmp = "<input type=\"checkbox\" id=\"chkIndexDJI\" name=\"chkIndexDJI\" value=\"\" checked onclick=\"chkIndexChanged(event)\">" +
                "<label for=\"chkIndexDJI\"> Dow</label>" +
                "<input type=\"checkbox\" id=\"chkIndexNasdaq\" name=\"chkIndexNasdaq\" value=\"\" checked onclick=\"chkIndexChanged(event)\">" +
                "<label for=\"chkIndexNasdaq\"> Nasdaq</label>" +
                "<input type=\"checkbox\" id=\"chkIndexSP\" name=\"chkIndexSP\" value=\"\" checked onclick=\"chkIndexChanged(event)\">" +
                "<label for=\"chkIndexSP\"> S&P 500</label>" +
                "<br />" +
                "<input type=\"checkbox\" id=\"chkIndexLargeBio\" name=\"chkIndexLargeBio\" value=\"\" checked onclick=\"chkIndexChanged(event)\">" +
                "<label for=\"chkIndexLargeBio\"> Large Bio</label>" +
                "<input type=\"checkbox\" id=\"chkIndexSmallBio\" name=\"chkIndexSmallBio\" value=\"\" checked onclick=\"chkIndexChanged(event)\">" +
                "<label for=\"chkIndexSmallBio\"> Small Bio</label>" +
                "<input type=\"checkbox\" id=\"chkIndexOther\" name=\"chkIndexOther\" value=\"\" onclick=\"chkIndexChanged(event)\">" +
                "<label for=\"chkIndexOther\"> Other</label>" +
                "<br />" +
        ...
        if (sCookie != null) {
            //cookie should contain (required) dji active (true or false)
            ...
            if (sTmp.length > 0) {
                if (sTmp.length > 5) {
                    ...
                    if (sTmp.length > 6) {
                        ...
                        let sIndexes = "";
                        for (let idx = 5; idx < sTmp.length; idx++) {
            ...
            if (sMarketsToTrack.length > 0) {
                ...
                for (let idx = 0; idx < sMarketsToTrack.length; idx++) {
                    ...
                    if (sMarket.length > 0) {
                        ...
                        sRow1 = sRow1 + "<td id=\"" + marketIndex.tdName + "\" style=\"color:black; vertical-align:top; text-align:left; width:" + gsMarketWidth + "px\"></td>";
                        sRow2 = sRow2 + "<td id=\"" + marketIndex.tdName + "Value\" style=\"color:black; vertical-align:top; text-align:left; width:" + gsMarketWidth + "px\"></td>";
    ...
    function SetupWatchlists(bDoingSymbols) {
        ...
        if (gbUsingCell) {
            if (gWatchlists.length > 0) {
                ...
                for (let idxWL = 0; idxWL < gWatchlists.length; idxWL++) {
                    if (((gWatchlists[idxWL].name == gsAccountSavedOrders) && (!bDoingSymbols)) || (gWatchlists[idxWL].name != gsAccountSavedOrders)) {
...
<BODY id="TheBody" style="background-color:#99CCFF; -webkit-text-size-adjust: 100%;" onload="window_onLoad()" onKeyUp="onKeyUp(event)" onkeydown="onKeyDown(event)">
        ...
        <table style="font-family:Arial, Helvetica, sans-serif; font-size:12pt;width:800px">
            <tr>
                <td id=tdLoggedOnAs>
                    ...
                    <span id="spanInfo" style="display:none; font-family:Arial, Helvetica, sans-serif; font-size:10pt;vertical-align:middle; text-align:left"><img src="Button-Info-icon25px.png" onclick="onClickInfo(event)" /></span>
                    <span id="spanDebug" style="font-family:Arial, Helvetica, sans-serif; font-size:10pt;vertical-align:middle; text-align:left"></span>
                </td>
            </tr>
            <tr>
                <td id="tdIndexes">
                    <input type="checkbox" id="chkIndexDJI" name="chkIndexDJI" value="" checked onclick="chkIndexChanged(event)">
                    <label for="chkIndexDJI"> Dow</label>
                    <input type="checkbox" id="chkIndexNasdaq" name="chkIndexNasdaq" value="" checked onclick="chkIndexChanged(event)">
                    <label for="chkIndexNasdaq"> Nasdaq</label>
                    <input type="checkbox" id="chkIndexSP" name="chkIndexSP" value="" checked onclick="chkIndexChanged(event)">
        ...
        <table style="font-family:Arial, Helvetica, sans-serif; font-size:12pt;width:800px">
            <tr>
                <td style="vertical-align:top; text-align:left">
                    ...
                    <br />
                    <input id="txtSymbols" name="txtSymbols" type="search" style="font-family:Arial, Helvetica, sans-serif; font-size:12pt;width:300px" value="">
                    <input type="button" style="border-radius:5px; visibility:visible;" id="btnSymSelect" name="btnSymSelect" value="..." onclick="SelectWatchlistSymbols()">
                    <input type="button" style="border-radius:5px; visibility:visible;" id="btnSymFind" name="btnSymFind" value="Portfolio" onclick="FindSymbolsInWatchlists()">
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top; text-align:left">
                    ...
                    <br />
                    <input maxlength=10 id="txtStartDate" name="txtStartDate" type="search" style="font-family:Arial, Helvetica, sans-serif; font-size:12pt;width:300px" value="">
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top; text-align:left">
                    End Date (yyyy-mm-dd):
                    <br />
                    <input maxlength=10 id="txtEndDate" name="txtEndDate" type="search" style="font-family:Arial, Helvetica, sans-serif; font-size:12pt;width:300px" value="">
                </td>
            </tr>
            <tr>
    ...
    <form id="MainForm" name="MainForm" style="display:block">
        <div id="tblSymbols" style="visibility:hidden; width:500px; position:absolute; top:0px; left:0px">
        ...
        <div id="tblDetail" style="visibility:hidden; position:absolute; top:0px; left:510px; width:500px;">
            <table style="width:100%; border-width:1px; border-style:solid;border-spacing:1px;border-color:White">
                <tr>
                    <!--
